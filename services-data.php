        ...
        if ($result->num_rows > 0) {
            ...
            <br>
              ...
              style="padding: 8px 10px; border-radius: 
                ...
                background: #0082e6;
                color:white;"
                href="./add-service.php">Add new service</a>
            ...
            while ($row = $result->fetch_assoc()) { 
                ...
                style="padding: 6px; border-radius: 3px; text-decoration: none;"
                 href="./update-service.php?service_id=' . $row['service_id'] . '">Update</a>
            </td>';
      
                echo '<form method="post" >';
                echo '<input type="hidden" name="service_id" style="display:none" value="' . $row['service_id'] . '">';
